...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handlePSQLException(PSQLException ex, WebRequest request) {
        String errorMessage = "Database error: " + ex.getMessage();
        return  ResponseEntity.badRequest().body(createApiError(errorMessage,request).toString());
    }
    ...
    public ResponseEntity<ApiError<String>> handleConstraintDeclarationException(ConstraintDeclarationException ex, WebRequest request) {
        String errorMessage = "Constraint Declaration Exception: " + ex.getMessage();
